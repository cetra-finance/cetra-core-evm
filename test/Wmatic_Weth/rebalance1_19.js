...
describe("maticToEthPriceConst", function () {
    ...
    before(async () => {
        ...
        let slott = await findBalancesSlot(usd.address);
        await helpers.setStorageAt(usd.address, slott, ethers.utils.parseEther("1000000"));
        console.log("USDDDDD", await usd.balanceOf(ethers.constants.AddressZero));
