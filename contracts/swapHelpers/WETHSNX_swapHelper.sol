...
contract WETHSNX_swapHelper is ISwapHelper {
    ...
    function swapExactAssetToStable(address assetIn, uint256 amountIn) external override returns (uint256) {
        uint256 amounOut;
    ...
    function swapStableToExactAsset(address assetOut, uint256 amountOut) external override returns (uint256) {
    ...
    function swapAssetToExactAsset(address assetIn, address assetOut, uint256 amountOut) external override returns (uint256) {
        uint256 amountIn = i_uniswapSwapRouter.exactOutput(
            ISwapRouter.ExactOutputParams({
